...
class GoogleLogin(SocialLoginView):
    ...
    callback_url = 'https://google-oauth-project-316971717795.asia-south1.run.app/auth/callback/'
...
def google_drive_callback(request):
    ...
    # Example: Passed from frontend
    expected_state = request.GET.get("expected_state")
...
def google_api_picker(request):
    ...
    # or remove this if not required
