...
urlpatterns += [
    ...
    path('google-drive/callback/', google_drive_callback,
         name='google_drive_callback'),
    path('google-drive/upload/', upload_file_to_drive, name='google_drive_upload'),
    path('google-drive/files/', list_drive_files,
         name='google_drive_list_files'),
    path('google-drive/download/<str:file_id>/',
         download_drive_file, name='google_drive_download'),
]
